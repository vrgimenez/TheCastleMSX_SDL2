...
static const struct {
    ...
    { 0x75, ROM_ADDR(0x8966), 1 },    /* wall tile */
    { 0x37, ROM_ADDR(0x7F66), 15 },   /* HUD/score (0x37-0x45, overwrites BG0) */
    { 0x77, ROM_ADDR(0x9116), 17 },   /* title block A (0x77-0x87) */
    { 0x88, ROM_ADDR(0x9926), 19 },   /* title block B (0x88-0x9A) */
    { 0xA3, ROM_ADDR(0x8356), 1 },    /* title tile */
    { 0xA4, ROM_ADDR(0x8366), 1 },
    { 0xA5, ROM_ADDR(0x8376), 1 },
    { 0xA6, ROM_ADDR(0x8386), 1 },
    { 0xAB, ROM_ADDR(0x83D6), 1 },
    { 0xAC, ROM_ADDR(0x83E6), 1 },
    { 0xAE, ROM_ADDR(0x8406), 1 },
    { 0xAF, ROM_ADDR(0x8416), 1 },
    { 0xB6, ROM_ADDR(0x8486), 1 },
    { 0xB7, ROM_ADDR(0x8496), 1 },
    { 0xB8, ROM_ADDR(0x84A6), 1 },
};
